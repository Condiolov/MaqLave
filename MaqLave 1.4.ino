...
/*
 * Versão oficial sem pal!! kkkkk
 * 09/10/2015
 * precisa da api do lcd LiquidCrystal_I2C 
 * e o drive do arduino xingling
 * Thiago Condé 
 */
...
int tmpCENRTRIFUGACAO = 2; // Tempo de Centrifugar 5 min
...
void centrifugar() {
  ...
  if (altura == 0) {
    ...
    while (((millis() - inicio) / 1000) < 60 * tmpCENRTRIFUGACAO) {
      lcd.setCursor(0, 0);
